...
public:
    ...
    void update_symbol_config(const std::string &symbol, const SymbolConfig &config);
...
private:
    ...
    bool validate_user_limits(const OrderRequest &order, const UserConfig &user_config, std::string &reason);
    bool validate_symbol_limits(const OrderRequest &order, const SymbolConfig &symbol_config, std::string &reason);
    bool validate_order_parameters(const OrderRequest &order, std::string &reason);
};
