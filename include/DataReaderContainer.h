...

{
    struct DataReaderContainer
    {
        ...
        distributed_ats_utils::topic_tuple_ptr<ExecutionReport> _execution_report_topic_tuple;
        distributed_ats_utils::data_reader_tuple_ptr<ExecutionReport> _execution_report_data_reader_tuple;
        ...
        {
            _execution_report_topic_tuple = participant_ptr->make_topic<ExecutionReportPubSubType, ExecutionReport>(EXECUTION_REPORT_TOPIC_NAME);
