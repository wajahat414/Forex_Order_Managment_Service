...
{
    set_name("ExecutionReport");
    uint32_t type_size = ExecutionReport_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = ExecutionReport_max_key_cdr_typesize > 16 ? ExecutionReport_max_key_cdr_typesize : 16;
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(key_buffer_),
            ExecutionReport_max_key_cdr_typesize);
    ...
    if (force_md5 || ExecutionReport_max_key_cdr_typesize > 16)
    {
        md5_.init();
