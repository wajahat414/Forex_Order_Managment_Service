...
/*!
 * @file ExecutionReportPubSubTypes.cpp
...
namespace DistributedATS_ExecutionReport {
    ExecutionReportPubSubType::ExecutionReportPubSubType()
    {
        set_name("DistributedATS_ExecutionReport::ExecutionReport");
        uint32_t type_size = DistributedATS_ExecutionReport_ExecutionReport_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedATS_ExecutionReport_ExecutionReport_max_key_cdr_typesize > 16 ? DistributedATS_ExecutionReport_ExecutionReport_max_key_cdr_typesize : 16;
    ...
    bool ExecutionReportPubSubType::deserialize(
            SerializedPayload_t& payload,
            void* data)
    {
        try
    ...
    uint32_t ExecutionReportPubSubType::calculate_serialized_size(
            const void* const data,
            DataRepresentationId_t data_representation)
    {
        try
            ...
            bool force_md5)
    {
        ...
        if (force_md5 || DistributedATS_ExecutionReport_ExecutionReport_max_key_cdr_typesize > 16)
        {
            md5_.init();
    ...
    void ExecutionReportPubSubType::register_type_object_representation()
    {
        register_ExecutionReport_type_identifier(type_identifiers_);
    }
