...
/*!
 * @file OrderResponseReportTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#include "OrderResponseReportTypeObjectSupport.hpp"
...
void register_OrderResponseReport_type_identifier(
        TypeIdentifierPair& type_ids_OrderResponseReport)
{

    ReturnCode_t return_code_OrderResponseReport {eprosima::fastdds::dds::RETCODE_OK};
    return_code_OrderResponseReport =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "OMS::OrderResponseReport", type_ids_OrderResponseReport);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_OrderResponseReport)
    {
        StructTypeFlag struct_flags_OrderResponseReport = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_OrderResponseReport = "OMS::OrderResponseReport";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_OrderResponseReport;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_OrderResponseReport;
        CompleteTypeDetail detail_OrderResponseReport = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_OrderResponseReport, ann_custom_OrderResponseReport, type_name_OrderResponseReport.to_string());
        CompleteStructHeader header_OrderResponseReport;
        header_OrderResponseReport = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_OrderResponseReport);
        CompleteStructMemberSeq member_seq_OrderResponseReport;
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_DATS_Source = TypeObjectUtils::build_complete_member_detail(name_DATS_Source, member_ann_builtin_DATS_Source, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_DATS_Source);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_DATS_Destination = TypeObjectUtils::build_complete_member_detail(name_DATS_Destination, member_ann_builtin_DATS_Destination, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_DATS_Destination);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_DATS_SourceUser = TypeObjectUtils::build_complete_member_detail(name_DATS_SourceUser, member_ann_builtin_DATS_SourceUser, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_DATS_SourceUser);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_DATS_DestinationUser = TypeObjectUtils::build_complete_member_detail(name_DATS_DestinationUser, member_ann_builtin_DATS_DestinationUser, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_DATS_DestinationUser);
        }
        {
            ...
            StructMemberFlag member_flags_OrderID = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrderID = 0x00000004;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrderID = TypeObjectUtils::build_complete_member_detail(name_OrderID, member_ann_builtin_OrderID, ann_custom_OrderResponseReport);
            CompleteStructMember member_OrderID = TypeObjectUtils::build_complete_struct_member(common_OrderID, detail_OrderID);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrderID);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrigClOrdID = TypeObjectUtils::build_complete_member_detail(name_OrigClOrdID, member_ann_builtin_OrigClOrdID, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrigClOrdID);
        }
        {
            ...
            StructMemberFlag member_flags_ExecID = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_ExecID = 0x00000006;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_ExecID = TypeObjectUtils::build_complete_member_detail(name_ExecID, member_ann_builtin_ExecID, ann_custom_OrderResponseReport);
            CompleteStructMember member_ExecID = TypeObjectUtils::build_complete_struct_member(common_ExecID, detail_ExecID);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_ExecID);
        }
        {
            ...
            StructMemberFlag member_flags_ExecType = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_ExecType = 0x00000007;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_ExecType = TypeObjectUtils::build_complete_member_detail(name_ExecType, member_ann_builtin_ExecType, ann_custom_OrderResponseReport);
            CompleteStructMember member_ExecType = TypeObjectUtils::build_complete_struct_member(common_ExecType, detail_ExecType);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_ExecType);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrdStatus = TypeObjectUtils::build_complete_member_detail(name_OrdStatus, member_ann_builtin_OrdStatus, ann_custom_OrderResponseReport);
            CompleteStructMember member_OrdStatus = TypeObjectUtils::build_complete_struct_member(common_OrdStatus, detail_OrdStatus);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrdStatus);
        }
        {
            ...
            StructMemberFlag member_flags_OrdRejReason = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrdRejReason = 0x00000009;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrdRejReason = TypeObjectUtils::build_complete_member_detail(name_OrdRejReason, member_ann_builtin_OrdRejReason, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrdRejReason);
        }
        {
            ...
            StructMemberFlag member_flags_Symbol = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Symbol = 0x0000000a;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_Symbol = TypeObjectUtils::build_complete_member_detail(name_Symbol, member_ann_builtin_Symbol, ann_custom_OrderResponseReport);
            CompleteStructMember member_Symbol = TypeObjectUtils::build_complete_struct_member(common_Symbol, detail_Symbol);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_Symbol);
        }
        {
            ...
            StructMemberFlag member_flags_SecurityExchange = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_SecurityExchange = 0x0000000b;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_SecurityExchange = TypeObjectUtils::build_complete_member_detail(name_SecurityExchange, member_ann_builtin_SecurityExchange, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_SecurityExchange);
        }
        {
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_Side = TypeObjectUtils::build_complete_member_detail(name_Side, member_ann_builtin_Side, ann_custom_OrderResponseReport);
            CompleteStructMember member_Side = TypeObjectUtils::build_complete_struct_member(common_Side, detail_Side);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_Side);
        }
        {
            ...
            StructMemberFlag member_flags_OrderQty = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrderQty = 0x0000000d;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrderQty = TypeObjectUtils::build_complete_member_detail(name_OrderQty, member_ann_builtin_OrderQty, ann_custom_OrderResponseReport);
            CompleteStructMember member_OrderQty = TypeObjectUtils::build_complete_struct_member(common_OrderQty, detail_OrderQty);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrderQty);
        }
        {
            ...
            StructMemberFlag member_flags_OrdType = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_OrdType = 0x0000000e;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_OrdType = TypeObjectUtils::build_complete_member_detail(name_OrdType, member_ann_builtin_OrdType, ann_custom_OrderResponseReport);
            CompleteStructMember member_OrdType = TypeObjectUtils::build_complete_struct_member(common_OrdType, detail_OrdType);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_OrdType);
        }
        {
            ...
            StructMemberFlag member_flags_Price = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Price = 0x0000000f;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_Price = TypeObjectUtils::build_complete_member_detail(name_Price, member_ann_builtin_Price, ann_custom_OrderResponseReport);
            CompleteStructMember member_Price = TypeObjectUtils::build_complete_struct_member(common_Price, detail_Price);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_Price);
        }
        {
            ...
            StructMemberFlag member_flags_StopPx = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_StopPx = 0x00000010;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_StopPx = TypeObjectUtils::build_complete_member_detail(name_StopPx, member_ann_builtin_StopPx, ann_custom_OrderResponseReport);
            CompleteStructMember member_StopPx = TypeObjectUtils::build_complete_struct_member(common_StopPx, detail_StopPx);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_StopPx);
        }
        {
            ...
            StructMemberFlag member_flags_TimeInForce = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_TimeInForce = 0x00000011;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_TimeInForce = TypeObjectUtils::build_complete_member_detail(name_TimeInForce, member_ann_builtin_TimeInForce, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_TimeInForce);
        }
        {
            ...
            StructMemberFlag member_flags_ExecInst = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_ExecInst = 0x00000012;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_ExecInst = TypeObjectUtils::build_complete_member_detail(name_ExecInst, member_ann_builtin_ExecInst, ann_custom_OrderResponseReport);
            CompleteStructMember member_ExecInst = TypeObjectUtils::build_complete_struct_member(common_ExecInst, detail_ExecInst);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_ExecInst);
        }
        {
            ...
            StructMemberFlag member_flags_LastQty = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_LastQty = 0x00000013;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_LastQty = TypeObjectUtils::build_complete_member_detail(name_LastQty, member_ann_builtin_LastQty, ann_custom_OrderResponseReport);
            CompleteStructMember member_LastQty = TypeObjectUtils::build_complete_struct_member(common_LastQty, detail_LastQty);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_LastQty);
        }
        {
            ...
            StructMemberFlag member_flags_LastPx = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_LastPx = 0x00000014;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_LastPx = TypeObjectUtils::build_complete_member_detail(name_LastPx, member_ann_builtin_LastPx, ann_custom_OrderResponseReport);
            CompleteStructMember member_LastPx = TypeObjectUtils::build_complete_struct_member(common_LastPx, detail_LastPx);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_LastPx);
        }
        {
            ...
            StructMemberFlag member_flags_LeavesQty = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_LeavesQty = 0x00000015;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_LeavesQty = TypeObjectUtils::build_complete_member_detail(name_LeavesQty, member_ann_builtin_LeavesQty, ann_custom_OrderResponseReport);
            CompleteStructMember member_LeavesQty = TypeObjectUtils::build_complete_struct_member(common_LeavesQty, detail_LeavesQty);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_LeavesQty);
        }
        {
            ...
            StructMemberFlag member_flags_CumQty = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_CumQty = 0x00000016;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_CumQty = TypeObjectUtils::build_complete_member_detail(name_CumQty, member_ann_builtin_CumQty, ann_custom_OrderResponseReport);
            CompleteStructMember member_CumQty = TypeObjectUtils::build_complete_struct_member(common_CumQty, detail_CumQty);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_CumQty);
        }
        {
            ...
            StructMemberFlag member_flags_AvgPx = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_AvgPx = 0x00000017;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_AvgPx = TypeObjectUtils::build_complete_member_detail(name_AvgPx, member_ann_builtin_AvgPx, ann_custom_OrderResponseReport);
            CompleteStructMember member_AvgPx = TypeObjectUtils::build_complete_struct_member(common_AvgPx, detail_AvgPx);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_AvgPx);
        }
        {
            ...
            StructMemberFlag member_flags_TransactTime = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_TransactTime = 0x00000018;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_TransactTime = TypeObjectUtils::build_complete_member_detail(name_TransactTime, member_ann_builtin_TransactTime, ann_custom_OrderResponseReport);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_TransactTime);
        }
        {
            ...
            StructMemberFlag member_flags_Text = TypeObjectUtils::build_struct_member_flag(eprosima::fastdds::dds::xtypes::TryConstructFailAction::DISCARD,
                    false, false, false, false);
            MemberId member_id_Text = 0x00000019;
            ...
            ann_custom_OrderResponseReport.reset();
            CompleteMemberDetail detail_Text = TypeObjectUtils::build_complete_member_detail(name_Text, member_ann_builtin_Text, ann_custom_OrderResponseReport);
            CompleteStructMember member_Text = TypeObjectUtils::build_complete_struct_member(common_Text, detail_Text);
            TypeObjectUtils::add_complete_struct_member(member_seq_OrderResponseReport, member_Text);
        }
        CompleteStructType struct_type_OrderResponseReport = TypeObjectUtils::build_complete_struct_type(struct_flags_OrderResponseReport, header_OrderResponseReport, member_seq_OrderResponseReport);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_OrderResponseReport, type_name_OrderResponseReport.to_string(), type_ids_OrderResponseReport))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "OMS::OrderResponseReport already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace OMS
