...
/*!
 * @file OrderResponseReportCdrAux.ipp
 * This source file contains some declarations of CDR related functions.
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#ifndef FAST_DDS_GENERATED__OMS_ORDERRESPONSEREPORTCDRAUX_IPP
#define FAST_DDS_GENERATED__OMS_ORDERRESPONSEREPORTCDRAUX_IPP
...
eProsima_user_DllExport size_t calculate_serialized_size(
        ...
        const OMS::OrderResponseReport& data,
        ...
        const OMS::OrderResponseReport& data)
{
    ...
    scdr
        ...
        << eprosima::fastcdr::MemberId(4) << data.OrderID()
        << eprosima::fastcdr::MemberId(5) << data.OrigClOrdID()
        << eprosima::fastcdr::MemberId(6) << data.ExecID()
        << eprosima::fastcdr::MemberId(7) << data.ExecType()
        << eprosima::fastcdr::MemberId(8) << data.OrdStatus()
        << eprosima::fastcdr::MemberId(9) << data.OrdRejReason()
        << eprosima::fastcdr::MemberId(10) << data.Symbol()
        << eprosima::fastcdr::MemberId(11) << data.SecurityExchange()
        << eprosima::fastcdr::MemberId(12) << data.Side()
        << eprosima::fastcdr::MemberId(13) << data.OrderQty()
        << eprosima::fastcdr::MemberId(14) << data.OrdType()
        << eprosima::fastcdr::MemberId(15) << data.Price()
        << eprosima::fastcdr::MemberId(16) << data.StopPx()
        << eprosima::fastcdr::MemberId(17) << data.TimeInForce()
        << eprosima::fastcdr::MemberId(18) << data.ExecInst()
        << eprosima::fastcdr::MemberId(19) << data.LastQty()
        << eprosima::fastcdr::MemberId(20) << data.LastPx()
        << eprosima::fastcdr::MemberId(21) << data.LeavesQty()
        << eprosima::fastcdr::MemberId(22) << data.CumQty()
        << eprosima::fastcdr::MemberId(23) << data.AvgPx()
        << eprosima::fastcdr::MemberId(24) << data.TransactTime()
        << eprosima::fastcdr::MemberId(25) << data.Text()
;
...
#endif // FAST_DDS_GENERATED__OMS_ORDERRESPONSEREPORTCDRAUX_IPP
