...
/*!
 * @file NewOrderSinglePubSubTypes.hpp
...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDATS_NEWORDERSINGLE_NEWORDERSINGLE_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDATS_NEWORDERSINGLE_NEWORDERSINGLE_PUBSUBTYPES_HPP
...
#error \
    Generated NewOrderSingle is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
namespace DistributedATS_NewOrderSingle
{
    ...
    /*!
     * @brief This class represents the TopicDataType of the type NewOrderSingle defined by the user in the IDL file.
    ...
    public:
        ...
        eProsima_user_DllExport ~NewOrderSinglePubSubType() override;
