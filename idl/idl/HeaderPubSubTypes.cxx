...
namespace DistributedATS {
    ...
    {
        set_name("DistributedATS::Header");
        uint32_t type_size = DistributedATS_Header_max_cdr_typesize;
        type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
        max_serialized_type_size = type_size + 4; /*encapsulation*/
        is_compute_key_provided = false;
        uint32_t key_length = DistributedATS_Header_max_key_cdr_typesize > 16 ? DistributedATS_Header_max_key_cdr_typesize : 16;
            ...
            bool force_md5)
    {
        ...
        if (force_md5 || DistributedATS_Header_max_key_cdr_typesize > 16)
        {
            md5_.init();
