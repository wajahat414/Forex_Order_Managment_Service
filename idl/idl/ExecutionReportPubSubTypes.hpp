...
/*!
 * @file ExecutionReportPubSubTypes.hpp
...
#ifndef FAST_DDS_GENERATED__DISTRIBUTEDATS_EXECUTIONREPORT_EXECUTIONREPORT_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__DISTRIBUTEDATS_EXECUTIONREPORT_EXECUTIONREPORT_PUBSUBTYPES_HPP
...
#error \
    Generated ExecutionReport is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
namespace DistributedATS_ExecutionReport
{
    ...
    /*!
     * @brief This class represents the TopicDataType of the type ExecutionReport defined by the user in the IDL file.
    ...
    public:
        ...
        eProsima_user_DllExport ~ExecutionReportPubSubType() override;
